...
export default function Phase5Section() {
  return (
    <section id="phase5" className="mb-12 scroll-mt-20">
      ...
      <div className="bg-[#0d1f3c] border border-[#1e3a5f] rounded-xl p-5 mb-8">
        ...
        <div className="flex flex-wrap gap-2">
          {['Antigravity', 'Gemini CLI', 'Cursor', 'GitHub Copilot Workspace'].map((tool) => (
            <span key={tool} className="text-xs bg-[#0a1628] border border-[#1e3a5f] text-[#94a3b8] px-3 py-1.5 rounded-full font-mono">
              {tool}
            </span>
          ))}
        </div>
      ...
      <div className="mb-10">
        ...
        <div className="space-y-4">
          {[
            ...
            <div key={item.step} className="flex gap-4 p-4 bg-[#0d1f3c] border border-[#1e3a5f] rounded-xl">
              <span className="text-xl font-bold text-[#1e3a5f] font-mono min-w-[36px]">{item.step}</span>
              <div>
      ...
      <section id="phase5-1" className="mt-10 scroll-mt-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {testingRules.map((rule) => {
            ...
            return (
              <div key={rule.title} className="bg-[#0d1f3c] border border-[#1e3a5f] rounded-xl p-5 hover:border-[#00d4ff]/20 transition-colors duration-200">
      ...
      <section id="phase5-2" className="mt-12 scroll-mt-20">
        ...
        <div className="space-y-4 mb-6">
          <div className="border border-[#1e3a5f] rounded-xl overflow-hidden">
            <div className="flex items-center gap-3 px-5 py-3 bg-[#0a1628] border-b border-[#1e3a5f]">
          ...
          <div className="border border-[#1e3a5f] rounded-xl overflow-hidden">
            ...
            <div className="p-5 bg-[#0d1f3c] space-y-2">
              ...
              <p className="text-xs text-[#94a3b8]">
                Alternativ: <kbd className="text-xs bg-[#0a1628] border border-[#1e3a5f] px-1.5 py-0.5 rounded font-mono">F5</kbd> drücken (VS Code Debugger), um den Code Zeile für Zeile zu prüfen.
              </p>
            </div>
          </div>
        </div>
