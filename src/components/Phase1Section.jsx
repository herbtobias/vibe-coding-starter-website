  ...
  return (
    <section id="phase1" className="mb-16 scroll-mt-20">
      ...
      <div className="mt-10 mb-8">
        ...
        <div className="space-y-4">
          {workflowSteps.map((step) => (
            <div key={step.num} className="flex gap-4 p-5 bg-[#0a1628] border border-[#162840] rounded-none hover:border-[#00d4ff]/30 transition-colors duration-200">
              <span className="text-2xl font-bold text-[#162840] font-mono min-w-[40px]">{step.num}</span>
              <div>
      ...
      <div className="mt-8">
        ...
        <div className="space-y-4">
          {archItems.map((group) => (
            <div key={group.title} className="border border-[#162840] rounded-none overflow-hidden">
              <div className="px-5 py-3 bg-[#0a1628] border-b border-[#162840]">
                <p className="text-sm font-semibold text-[#00d4ff]">{group.title}</p>
              </div>
              <div className="divide-y divide-[#162840]">
                {group.items.map((item) => (
                  <div key={item.name} className="px-5 py-4 bg-[#0a1628] flex gap-3">
