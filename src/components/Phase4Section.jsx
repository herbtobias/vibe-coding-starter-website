    ...
    <section id="phase4" className="mb-12 scroll-mt-20">
      ...
      <div className="space-y-4 mb-6">
        {steps.map((step, i) => {
          ...
          return (
            <div key={i} className="flex gap-4 items-start p-4 bg-[#0a1628] border border-[#162840] rounded-none">
              <div className="w-8 h-8 rounded-none bg-[#0a1628] border border-[#162840] flex items-center justify-center shrink-0">
      ...
      <section id="phase4-1" className="mt-12 scroll-mt-20">
        ...
        <div className="space-y-6">
          <div className="border border-[#162840] rounded-none overflow-hidden">
            <div className="px-5 py-4 bg-[#0a1628] border-b border-[#162840] flex items-center gap-2">
              <span className="w-6 h-6 rounded-sm bg-[#00d4ff]/10 border border-[#00d4ff]/20 flex items-center justify-center text-xs font-bold text-[#00d4ff]">1</span>
          ...
          <div className="border border-[#162840] rounded-none overflow-hidden">
            <div className="px-5 py-4 bg-[#0a1628] border-b border-[#162840] flex items-center gap-2">
              <span className="w-6 h-6 rounded-sm bg-[#00d4ff]/10 border border-[#00d4ff]/20 flex items-center justify-center text-xs font-bold text-[#00d4ff]">2</span>
          ...
          <div className="border border-[#162840] rounded-none overflow-hidden">
            <div className="px-5 py-4 bg-[#0a1628] border-b border-[#162840] flex items-center gap-2">
              <span className="w-6 h-6 rounded-sm bg-[#00d4ff]/10 border border-[#00d4ff]/20 flex items-center justify-center text-xs font-bold text-[#00d4ff]">3</span>
              <div className="flex items-center gap-2">
